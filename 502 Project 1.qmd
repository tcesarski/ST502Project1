...
simplified_wald_summary <- data.frame(sample_size = n_values, p = repeated_p, coverage_probs = wald_coverage_probabilities)

simplified_cp_summary <- data.frame(sample_size = n_values, p = repeated_p, coverage_probs = cp_coverage_probabilities)

simplified_boot_summary <- data.frame(sample_size = n_values, p = repeated_p, coverage_probs = boot_coverage_probabilities)
